...
plt.savefig("Figure_1_shap_value_coarse_"+region+".png", format='png', dpi='figure', bbox_inches='tight')
plt.close()

## Generate summary bar plot
shap.summary_plot(shap_values, X,plot_type="bar",show=False)
plt.savefig("Figure_2_mean_shap_value_coarse_"+region+".png", format='png', dpi='figure', bbox_inches='tight')
plt.close()

## Generate specific dependence plots
shap.dependence_plot("PBL", shap_values, X, interaction_index="TEMP2", alpha=0.1, show=False)
plt.savefig("Figure_3_dependence_plot_coarse_"+region+"_PBL_TEMP2.png", format='png', dpi='figure', bbox_inches='tight')
plt.close()

shap.dependence_plot("TEMP2", shap_values, X, interaction_index="PBL", alpha=0.1, show=False)
plt.savefig("Figure_3_dependence_plot_coarse_"+region+"_TEMP2_PBL.png", format='png', dpi='figure', bbox_inches='tight')
plt.close()

shap.dependence_plot("GSW", shap_values, X, interaction_index="CFRAC", alpha=0.1, show=False)
plt.savefig("Figure_3_dependence_plot_coarse_"+region+"_GSW_CFRAC.png", format='png', dpi='figure', bbox_inches='tight')
plt.close()

shap.dependence_plot("CFRAC", shap_values, X, interaction_index="GSW", alpha=0.1, show=False)
plt.savefig("Figure_3_dependence_plot_coarse_"+region+"_CFRAC_GSW.png", format='png', dpi='figure', bbox_inches='tight')
plt.close()

shap.dependence_plot("Q2", shap_values, X, interaction_index="PRECIP", alpha=0.1, show=False)
plt.savefig("Figure_3_dependence_plot_coarse_"+region+"_Q2_PRECIP.png", format='png', dpi='figure', bbox_inches='tight')
plt.close()

shap.dependence_plot("BE_VOC", shap_values, X, interaction_index="TEMP2", alpha=0.1, show=False)
plt.savefig("Figure_3_dependence_plot_coarse_"+region+"_BE_VOC_TEMP2.png", format='png', dpi='figure', bbox_inches='tight')
plt.close()

shap.dependence_plot("TEMP2", shap_values, X, interaction_index="BE_VOC", alpha=0.1, show=False)
plt.savefig("Figure_3_dependence_plot_coarse_"+region+"_TEMP2_BE_VOC.png", format='png', dpi='figure', bbox_inches='tight')
plt.close()

shap.dependence_plot("BE_VOC", shap_values, X, interaction_index="GSW", alpha=0.1, show=False)
plt.savefig("Figure_3_dependence_plot_coarse_"+region+"_BE_VOC_GSW.png", format='png', dpi='figure', bbox_inches='tight')
plt.close()

shap.dependence_plot("BE_VOC", shap_values, X, interaction_index="LAI", alpha=0.1, show=False)
plt.savefig("Figure_3_dependence_plot_coarse_"+region+"_BE_VOC_LAI.png", format='png', dpi='figure', bbox_inches='tight')
plt.close()

shap.dependence_plot("LAI", shap_values, X, interaction_index="BE_VOC", alpha=0.1, show=False)
plt.savefig("Figure_3_dependence_plot_coarse_"+region+"_LAI_BE_VOC.png", format='png', dpi='figure', bbox_inches='tight')
plt.close()

shap.dependence_plot("GSW", shap_values, X, interaction_index="BE_VOC", alpha=0.1, show=False)
plt.savefig("Figure_3_dependence_plot_coarse_"+region+"_GSW_BE_VOC.png", format='png', dpi='figure', bbox_inches='tight')
plt.close()

shap.dependence_plot("BE_NO", shap_values, X, interaction_index="PRECIP", alpha=0.1, show=False)
plt.savefig("Figure_3_dependence_plot_coarse_"+region+"_BE_NO_PRECIP.png", format='png', dpi='figure', bbox_inches='tight')
plt.close()

shap.dependence_plot("PRECIP", shap_values, X, interaction_index="BE_NO", alpha=0.1, show=False)
plt.savefig("Figure_3_dependence_plot_coarse_"+region+"_PRECIP_BE_NO.png", format='png', dpi='figure', bbox_inches='tight')
plt.close()

shap.dependence_plot("WDIR10", shap_values, X, interaction_index="WSPD10", alpha=0.1, show=False)
plt.savefig("Figure_3_dependence_plot_coarse_"+region+"_WDIR10_WSPD10.png", format='png', dpi='figure', bbox_inches='tight')
plt.close()

shap.dependence_plot("WDIR10", shap_values, X, interaction_index="TEMP2", alpha=0.1, show=False)
plt.savefig("Figure_3_dependence_plot_coarse_"+region+"_WDIR10_TEMP2.png", format='png', dpi='figure', bbox_inches='tight')
plt.close()

shap.dependence_plot("WSPD10", shap_values, X, interaction_index="WDIR10", alpha=0.1, show=False)
plt.savefig("Figure_3_dependence_plot_coarse_"+region+"_WSPD10_WDIR10.png", format='png', dpi='figure', bbox_inches='tight')
plt.close()

shap.dependence_plot("AE_NOX", shap_values, X, interaction_index="AE_VOC", alpha=0.1, show=False)
plt.savefig("Figure_3_dependence_plot_coarse_"+region+"_AE_NOX_AE_VOC.png", format='png', dpi='figure', bbox_inches='tight')
plt.close()

shap.dependence_plot("AE_VOC", shap_values, X, interaction_index="AE_NOX", alpha=0.1, show=False)
plt.savefig("Figure_3_dependence_plot_coarse_"+region+"_AE_VOC_AE_NOX.png", format='png', dpi='figure', bbox_inches='tight')
plt.close()

shap.dependence_plot("AE_CO", shap_values, X, interaction_index=None, alpha=0.1, show=False)
plt.savefig("Figure_3_dependence_plot_coarse_"+region+"_AE_CO.png", format='png', dpi='figure', bbox_inches='tight')
plt.close()
...
plt.savefig("Figure_5_waterfall_legacy_first_coarse_"+region+".png", format='png', dpi='figure', bbox_inches='tight')
plt.close()
#
...
plt.savefig("Figure_5_waterfall_legacy_last_coarse_"+region+".png", format='png', dpi='figure', bbox_inches='tight')
plt.close()
#
...
plt.savefig("Figure_7_decision_plot_first_coarse_"+region+".png", format='png', dpi='figure', bbox_inches='tight')
plt.close()
#
...
plt.savefig("Figure_7_decision_plot_last_coarse_"+region+".png", format='png', dpi='figure', bbox_inches='tight')
plt.close()
#
...
plt.savefig("Figure_7_decision_plot_multiple_100_coarse_"+region+".png", format='png', dpi='figure', bbox_inches='tight')
plt.close()
